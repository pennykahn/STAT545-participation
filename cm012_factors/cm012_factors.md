...
![](cm012_factors_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
```r
gap <- gapminder %>% 
  filter(country %in% c("Afghanistan", "Germany", "South Africa", "Chile", "Vietnam"))
...
![](cm012_factors_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
![](cm012_factors_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
